...
==============================================================
Student ID: AI20K-2A202600857  (<-- Thay XXXX bang ma so cua ban)
Name: Pham Tran Nguyen Phu
...
def validate(data):
    ...
    print(f"Validation complete. {len(valid_records)} kept, {error_count} dropped.")
